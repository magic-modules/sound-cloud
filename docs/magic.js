...
var SoundCloud = function SoundCloud(props) {
  var _props$src = props.src,
      src = _props$src === void 0 ? false : _props$src,
      _props$height = props.height,
      height = _props$height === void 0 ? false : _props$height,
      _props$type = props.type,
      type = _props$type === void 0 ? 'tracks' : _props$type;
  var _props$id = props.id,
      id = _props$id === void 0 ? false : _props$id,
      _props$visual = props.visual,
      visual = _props$visual === void 0 ? type.startsWith('track') ? false : true : _props$visual,
      _props$show_teaser = props.show_teaser,
      show_teaser = _props$show_teaser === void 0 ? false : _props$show_teaser,
      _props$show_reposts = props.show_reposts,
      show_reposts = _props$show_reposts === void 0 ? false : _props$show_reposts,
      _props$show_user = props.show_user,
      show_user = _props$show_user === void 0 ? true : _props$show_user,
      _props$show_comments = props.show_comments,
      show_comments = _props$show_comments === void 0 ? false : _props$show_comments,
      _props$auto_play = props.auto_play,
      auto_play = _props$auto_play === void 0 ? false : _props$auto_play,
      _props$hide_related = props.hide_related,
      hide_related = _props$hide_related === void 0 ? true : _props$hide_related,
      _props$width = props.width,
      width = _props$width === void 0 ? '100%' : _props$width,
      _props$scrolling = props.scrolling,
      scrolling = _props$scrolling === void 0 ? 'no' : _props$scrolling,
      _props$frameborder = props.frameborder,
      frameborder = _props$frameborder === void 0 ? 'no' : _props$frameborder;
  ...
  if (!src) {
    ...
    var host = 'https://w.soundcloud.com/player';
    var url = "https://api.soundcloud.com/".concat(type, "/").concat(id);
    src = lib.uri.encode({
      host: host,
      params: {
        url: url,
...
var lib = {
  ...
  uri: function () {
    var encode = function encode() {
      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var _props$host2 = props.host,
          host = _props$host2 === void 0 ? '' : _props$host2,
          _props$params = props.params,
          params = _props$params === void 0 ? {} : _props$params;
      var query = Object.entries(params).map(function (_ref19) {
...
var actions = {
  ...
  'gdpr': {
    ...
    'toggleAllow': function toggleAllow(state, _ref21) {
  ...
  'pre': {
    'clip': function clip(state, _ref22) {
...
var pages = {
  '/sound-cloud/': function soundCloud(state) {
    return [h1(state.title), p(['this is the ', Link({
      to: 'https://github.com/magic-modules'
    }, '@magic-modules'), ' SoundCloud component.', state.description]), GitBadges('magic-modules/sound-cloud'), h2({
      id: 'installation'
    }, 'installation:'), Pre('npm install @magic-modules/sound-cloud'), h2({
      id: 'usage'
    }, 'usage:'), p('in a page or module View'), Pre('export const View = () => SoundCloud(props)'), h3({
      id: 'usage-tracks'
    }, 'tracks'), p('the track type shows a single track'), Pre("SoundCloud({ type: 'track', id: '599883213' })"), p('renders'), SoundCloud({
      type: 'track',
      id: 599883213,
      visual: false
    }), h3({
      id: 'usage-playlists'
    }, 'playlists'), p('the playlists type shows a playlist'), Pre("SoundCloud({ type: 'playlist', id: '613360614' })"), p('renders'), SoundCloud({
      type: 'playlist',
      id: 293975290
    }), h3({
      id: 'usage-users'
    }, 'users'), p('the users type shows a user profile'), Pre("SoundCloud({ type: 'user', id: '151832569' })"), p('renders'), SoundCloud({
      type: 'user',
      id: 151832569
    }), h2({
      id: 'usage-default-arguments'
    }, 'default arguments'), p('@magic tries to keep the default arguments for soundcloud sane.'), Pre("{\n    visual = true,         // set to false to get a smaller view with 166px height\n    show_teaser = false,   // show an overlay with soundcloud ads\n    show_reposts = false,  // show reposts for this track/user/playlist\n    show_user = true,      // show the user that uploaded the track or playlist\n    show_comments = false, // show comments people left\n    auto_play = false,     // auto play video (will not work in many browsers anyways)\n    hide_related = true,   // hide artists that might match or not\n    height = 300 || 166,   // default height for visual true || false\n    width = '100%',\n    scrolling = 'no',\n    frameborder = 'no',\n  }"), h2({
      id: 'source'
  ...
  '/sound-cloud/404/': function soundCloud404() {
